...
Rails.application.config.assets.precompile += ['managers/selected_nodes_tree.js', 'managers/node_subject_checkpoints.js', 'managers/node_structure_catalog.js', 'managers/node_catalog_checkpoint_combination.js']
