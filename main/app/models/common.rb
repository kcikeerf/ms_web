...
<li>
四分位区间划分：将一组数据从大到小排列，然后计算出数据对应的百分等级，
处于大于75%的数据叫做上四分位数区间；处于75%~50%的数据叫中上四分位区间；
处于50%~25%的数据叫中下四分位区间；处于小于25%的数据叫做下四分位区间。
</li>
<li>
满分值：本次测试为每个指标设定的最高值。
</li>
...
<li>认知是英语学习中所必须的基础技能。如果年级学生在此项技能上的得分率较低，表明基本功还不扎实。学生英语上所投入的时间和精力还存在不足，或者是方法不对。
